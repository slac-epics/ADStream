...
#- NDColorConvertConfigure( portName, queueSize, blockingCallbacks, dataSrcPortName, addr, maxBuffers, maxMemory, priority, stackSize, maxThreads )
...
NDColorConvertConfigure( "CC$(N)", $(QSIZE), 0, "$(PLUGIN_SRC)", 0, 0, 0, 0, 0, $(MAX_THREADS=5) ))

#- Load the plugin records
dbLoadRecords( "db/pluginColorConvert.db",  "CAM=$(CAM_PV),CAM_PORT=$(CAM_PORT),PLUGIN_SRC=$(PLUGIN_SRC),N=$(N)" )
