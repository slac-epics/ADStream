...
NDStdArraysConfigure( "$(IMAGE_NAME)", $(QSIZE), 0, "$(PLUGIN_SRC)", 0, 0, 0, 0, 0, $(MAX_THREADS=5) )

#- Load the plugin records
dbLoadRecords( "db/pluginImage.db",  "CAM=$(CAM_PV),CAM_PORT=$(CAM_PORT),PLUGIN_SRC=$(PLUGIN_SRC),IMAGE_NAME=$(IMAGE_NAME),IMAGE_NELM=$(IMAGE_NELM),IMAGE_FTVL=$(IMAGE_FTVL),IMAGE_TYPE=$(IMAGE_TYPE)" )
