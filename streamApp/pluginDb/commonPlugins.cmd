...
NDTimeSeriesConfigure(  "Stats1_TS","$(QSIZE)",0, "$(PLUGIN_SRC)", 0, 0, 0, 0, 0, 0 )
NDStatsConfigure(       "Stats2",  "$(QSIZE)", 0, "$(CAM_PORT)", 0, 0, 0, 0, 0, $(MAX_THREADS=5) )
NDTimeSeriesConfigure(  "Stats2_TS","$(QSIZE)",0, "$(PLUGIN_SRC)", 0, 0, 0, 0, 0, 0 )
NDStatsConfigure(       "Stats3",  "$(QSIZE)", 0, "$(CAM_PORT)", 0, 0, 0, 0, 0, $(MAX_THREADS=5) )
NDTimeSeriesConfigure(  "Stats3_TS","$(QSIZE)",0, "$(PLUGIN_SRC)", 0, 0, 0, 0, 0, 0 )
NDStatsConfigure(       "Stats4",  "$(QSIZE)", 0, "$(CAM_PORT)", 0, 0, 0, 0, 0, $(MAX_THREADS=5) )
NDTimeSeriesConfigure(  "Stats4_TS","$(QSIZE)",0, "$(PLUGIN_SRC)", 0, 0, 0, 0, 0, 0 )
NDStatsConfigure(       "Stats5",  "$(QSIZE)", 0, "$(CAM_PORT)", 0, 0, 0, 0, 0, $(MAX_THREADS=5) )
NDTimeSeriesConfigure(  "Stats5_TS","$(QSIZE)",0, "$(PLUGIN_SRC)", 0, 0, 0, 0, 0, 0 )
